...
To get the positive half of the spectrum, first compute the 
...
def minimizeEnergySpreadDFT(x, fs, f1, f2):
    ...
    """
    sampleSeconds = 1 / fs
    periodSamples1 = fs  / f1
    periodSamples2 = fs  / f2
    M = periodSamples1 * periodSamples2 / ( gcd( periodSamples1, periodSamples2 ) )
    X = fft(x,M)
